...
class ActivityTracker {
    ...
    init() {
        ...
        console.log('Activity Tracker: Detected activity type:', this.activityType, 'for path:', window.location.pathname);
        ...
        if (this.activityType) {
            ...
            console.log('Activity Tracker: No activity type detected, tracker not started');
        }
    }
    ...
    detectActivityType() {
        ...
        } else if (path.includes('/dashboard/') || path.includes('/reviewer/') || path === '/') {
    ...
    getCSRFToken() {
        ...
        console.warn('Activity Tracker: CSRF token not found');
        return '';
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const isRelevantPage = relevantPages.some(page => currentPath.includes(page)) || currentPath === '/';
