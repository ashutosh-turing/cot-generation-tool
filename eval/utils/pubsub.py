...
# Create a publisher client for llm-requests
...
# Create a publisher client for llm-notifications
notification_topic_id = "llm-notifications"
...
def publish_message(data):
    ...
    """Publishes a message to the llm-requests topic."""
    try:
...
def publish_notification(data):
    """Publishes a notification to the llm-notifications topic."""
    try:
