...
urlpatterns = [
    ...
    path('api/project-criteria/update/', views.update_project_criteria, name='update_project_criteria'),
    path('api/project-criteria/bulk-update/', views.bulk_update_project_criteria, name='bulk_update_project_criteria'),
